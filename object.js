...
now we can not access the name property of the person through the dot notation
 because it will give us an error because it is not a valid identifier but we can access it through the bracket notation because it is a valid identifier in the bracket notation*/
